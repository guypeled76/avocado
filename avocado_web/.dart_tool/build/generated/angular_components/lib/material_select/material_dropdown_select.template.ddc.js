  ...
  material_select__material_dropdown_select$46template.ViewMaterialDropdownSelectComponent0$ = dart.generic(T => {
    ...
    class ViewMaterialDropdownSelectComponent0 extends src__core__linker__app_view.AppView$(material_select__material_dropdown_select.MaterialDropdownSelectComponent$(T)) {
      ...
      build() {
        ...
        this.createAttr(_el_0, "initPopupAriaAttributes", "false");
        this.createAttr(_el_0, "popupSource", "");
        this.createAttr(_el_0, "popupType", "listbox");
        this.addShimC(_el_0);
        ...
        this.createAttr(_el_5, "footer", "");
        this.addShimC(html.HtmlElement._check(_el_5));
        this.project(_el_5, 5);
        this[_compView_2].create(this[_MaterialPopupComponent_2_8], [JSArrayOfElement().of([_el_3]), JSArrayOfViewContainer().of([this[_appEl_4]]), JSArrayOfElement().of([_el_5])]);
        ...
        _el_3[$addEventListener]("keydown", this.eventHandler1(html.Event, html.KeyboardEvent, dart.bind(this.ctx, 'onKeyDown')));
        _el_3[$addEventListener]("keypress", this.eventHandler1(html.Event, html.KeyboardEvent, dart.bind(this.ctx, 'onKeyPress')));
        _el_3[$addEventListener]("keyup", this.eventHandler1(html.Event, html.KeyboardEvent, dart.bind(this.ctx, 'onKeyUp')));
        _el_5[$addEventListener]("keydown", this.eventHandler1(html.Event, html.KeyboardEvent, dart.bind(this.ctx, 'onKeyDown')));
        _el_5[$addEventListener]("keypress", this.eventHandler1(html.Event, html.KeyboardEvent, dart.bind(this.ctx, 'onKeyPress')));
        _el_5[$addEventListener]("keyup", this.eventHandler1(html.Event, html.KeyboardEvent, dart.bind(this.ctx, 'onKeyUp')));
