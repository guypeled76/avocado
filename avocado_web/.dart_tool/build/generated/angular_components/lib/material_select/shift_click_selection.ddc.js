  ...
  material_select__shift_click_selection.ShiftClickSelectionMixin$ = dart.generic(T => {
    class ShiftClickSelectionMixin extends core.Object {
      ...
      handle(event, activatedValue) {
        ...
        this[_handleClick](html.MouseEvent._check(event), T.as(activatedValue));
        return true;
      }
    }
    ...
    ShiftClickSelectionMixin[dart.implements] = () => [material_select__activation_handler.ActivationHandler];
