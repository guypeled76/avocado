  ...
  material_input__material_auto_suggest_input$46template.ViewMaterialAutoSuggestInputComponent0$ = dart.generic(T => {
    ...
    class ViewMaterialAutoSuggestInputComponent0 extends src__core__linker__app_view.AppView$(material_input__material_auto_suggest_input.MaterialAutoSuggestInputComponent$(T)) {
      ...
      build() {
        ...
        this.createAttr(_el_4, "header", "");
        this.createAttr(_el_4, "keyboardOnlyFocusIndicator", "");
        _el_4.tabIndex = -1;
        ...
        this.createAttr(_el_6, "footer", "");
        this.createAttr(_el_6, "keyboardOnlyFocusIndicator", "");
        _el_6.tabIndex = -1;
        ...
        this[_compView_3].create(this[_MaterialPopupComponent_3_8], [JSArrayOfElement().of([_el_4]), JSArrayOfViewContainer().of([this[_appEl_5]]), JSArrayOfElement().of([_el_6])]);
        ...
        _el_4[$addEventListener]("keyup", this.eventHandler1(html.Event, html.KeyboardEvent, dart.bind(this.ctx, 'onKeyUp')));
        ...
        _el_6[$addEventListener]("keyup", this.eventHandler1(html.Event, html.KeyboardEvent, dart.bind(this.ctx, 'onKeyUp')));
  ...
  material_input__material_auto_suggest_input$46template._ViewMaterialAutoSuggestInputComponent2$ = dart.generic(T => {
    ...
    class _ViewMaterialAutoSuggestInputComponent2 extends src__core__linker__app_view.AppView$(material_input__material_auto_suggest_input.MaterialAutoSuggestInputComponent$(T)) {
      build() {
        ...
        _el_0[$addEventListener]("keydown", this.eventHandler1(html.Event, html.KeyboardEvent, dart.bind(this.ctx, 'onKeyDown')));
        _el_0[$addEventListener]("keypress", this.eventHandler1(html.Event, html.KeyboardEvent, dart.bind(this.ctx, 'onKeyPress')));
        _el_0[$addEventListener]("keyup", this.eventHandler1(html.Event, html.KeyboardEvent, dart.bind(this.ctx, 'onKeyUp')));
        this.init0(_el_0);
      }
      detectChangesInternal() {
        let _ctx = this.ctx;
