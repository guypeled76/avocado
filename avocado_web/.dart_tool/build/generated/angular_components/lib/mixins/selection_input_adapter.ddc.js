    ...
    class SelectionInputAdapter extends core.Object {
      ...
      set optionsInput(value) {
        if (value == null || SelectionOptionsOfT().is(value)) {
          ...
          dart.throw(new core.ArgumentError.new("Unsupported selection options type; value must be null, " + ("SelectionOptions<" + dart.str(dart.wrapType(T)) + ">, or List<" + dart.str(dart.wrapType(T)) + ">, but is " + dart.str(dart.runtimeType(value)))));
        }
      }
    }
