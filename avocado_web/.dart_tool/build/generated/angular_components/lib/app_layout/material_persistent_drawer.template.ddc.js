define(['dart_sdk', 'packages/angular/src/bootstrap/modules', 'packages/angular/src/core/change_detection/directive_change_detector', 'packages/angular_components/app_layout/material_persistent_drawer', 'packages/angular_components/app_layout/material_drawer_base.template', 'packages/angular/angular.template', 'packages/angular_components/content/deferred_content_aware.template'], function(dart_sdk, modules, directive_change_detector, material_persistent_drawer, material_drawer_base, angular, deferred_content_aware) {
  ...
  }, '{"version":3,"sourceRoot":"","sources":["material_persistent_drawer.template.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;IAgBkD;;;;;;sBAIzB,IAAqB,EAAE,EAAkB;AAC9D,UAAM,YAAY,aAAQ,uBAAuB;AACjD,oBAAI,AAAQ,8CAAY,CAAC,aAAO,EAAE,SAAS,IAAG;AAC5C,4BAAe,CAAC,EAAE,EAAE,wBAAwB,SAAS;AACrD,qBAAO,GAAG,SAAS;;AAErB,UAAM,YAAY,aAAQ,sBAAsB;AAChD,oBAAI,AAAQ,8CAAY,CAAC,aAAO,EAAE,SAAS,IAAG;AAC5C,4BAAe,CAAC,EAAE,EAAE,uBAAuB,SAAS;AACpD,qBAAO,GAAG,SAAS;;IAEvB;;0GAZsC,QAAa;IAF9C,aAAO;IACP,aAAO;IAC+B,eAAQ,GAAR,QAAQ;;EAAC;;;;;;;;;;MAelD,0DAAQ;YAAG;;;;;AAEb,kBAAI,0DAAQ,GAAE;AACZ;;AAEF,iEAAW;AAEX,IAAM,yDAAa;AACnB,IAAM,gCAAa;AACnB,IAAM,wDAAa;EACrB","file":"material_persistent_drawer.template.ddc.js"}');
  // Exports:
  return {
