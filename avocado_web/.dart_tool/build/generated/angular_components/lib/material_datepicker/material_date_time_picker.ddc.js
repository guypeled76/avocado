define(['dart_sdk', 'packages/intl/intl', 'packages/angular_components/model/date/date', 'packages/angular_components/interfaces/has_disabled', 'packages/quiver/time'], function(dart_sdk, intl, date, has_disabled, time) {
  ...
  dart.defineLazy(material_datepicker__material_date_time_picker.MaterialDateTimePickerComponent, {
    /*material_datepicker__material_date_time_picker.MaterialDateTimePickerComponent.tabIndex*/get tabIndex() {
      return -1;
    }
  });
