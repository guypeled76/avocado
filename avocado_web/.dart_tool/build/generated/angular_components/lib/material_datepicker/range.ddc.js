define(['dart_sdk', 'packages/angular_components/model/date/date', 'packages/angular_components/material_datepicker/proto/date_range.pb', 'packages/angular_components/material_datepicker/proto/date.pb', 'packages/quiver/time', 'packages/intl/intl'], function(dart_sdk, date, date_range, date$, time, intl) {
  ...
  material_datepicker__range.NextNDaysFromTodayRange = class NextNDaysFromTodayRange extends material_datepicker__range.MultipleDaysRange {
    ...
    static _nextNDaysFromTodayMsg(lengthInDays) {
      return intl$.Intl.plural(core.int._check(lengthInDays), {one: "Today", other: dart.str(lengthInDays) + " days from today", name: "_nextNDaysFromTodayMsg", args: [lengthInDays], desc: "A date range containing the next \"lengthInDays\" days, " + "starting with today. [REL_NOTE:brockschmid/01-01-2019]", examples: const$3 || (const$3 = dart.constMap(core.String, dart.dynamic, ["lengthInDays", 7]))});
    }
  };
  ...
  material_datepicker__range.WeekRange = class WeekRange extends core.Object {
    ...
    static _weeksAgoMsg(weeksAgo) {
      return intl$.Intl.plural(core.int._check(weeksAgo), {zero: "This week", one: "Last week", other: dart.str(weeksAgo) + " weeks ago", name: "_weeksAgoMsg", args: [weeksAgo], desc: "A date range spanning a single week in the past.", examples: const$4 || (const$4 = dart.constMap(core.String, dart.dynamic, ["weeksAgo", 2]))});
    }
    static _weeksFromNowMsg(weeksFromNow) {
      return intl$.Intl.plural(core.int._check(weeksFromNow), {zero: "This week", one: "Next week", other: dart.str(weeksFromNow) + " weeks from now", name: "_weeksFromNowMsg", args: [weeksFromNow], desc: "A date range spanning a single week in the future.", examples: const$5 || (const$5 = dart.constMap(core.String, dart.dynamic, ["weeksFromNow", 2]))});
    }
  };
  ...
  material_datepicker__range.MonthRange = class MonthRange extends core.Object {
    ...
    static _monthsAgoMsg(monthsAgo) {
      return intl$.Intl.plural(core.int._check(monthsAgo), {zero: "This month", one: "Last month", other: dart.str(monthsAgo) + " months ago", name: "_monthsAgoMsg", args: [monthsAgo], desc: "A date range spanning a single month in the past.", examples: const$6 || (const$6 = dart.constMap(core.String, dart.dynamic, ["monthsAgo", 2]))});
    }
    static _monthsFromNowMsg(monthsFromNow) {
      return intl$.Intl.plural(core.int._check(monthsFromNow), {zero: "This month", one: "Next month", other: dart.str(monthsFromNow) + " months from now", name: "_monthsFromNowMsg", args: [monthsFromNow], desc: "A date range spanning a single month in the future.", examples: const$7 || (const$7 = dart.constMap(core.String, dart.dynamic, ["monthsFromNow", 2]))});
    }
  };
  ...
  material_datepicker__range.YearRange = class YearRange extends core.Object {
    ...
    static _yearsAgoMsg(yearsAgo) {
      return intl$.Intl.plural(core.int._check(yearsAgo), {zero: "This year", one: "Last year", other: dart.str(yearsAgo) + " years ago", name: "_yearsAgoMsg", args: [yearsAgo], desc: "A date range spanning a single year in the past.", examples: const$10 || (const$10 = dart.constMap(core.String, dart.dynamic, ["yearsAgo", 2]))});
    }
    static _yearsFromNowMsg(yearsFromNow) {
      return intl$.Intl.plural(core.int._check(yearsFromNow), {zero: "This year", one: "Next year", other: dart.str(yearsFromNow) + " years from now", name: "_yearsFromNowMsg", args: [yearsFromNow], desc: "A date range spanning a single year in the future.", examples: const$11 || (const$11 = dart.constMap(core.String, dart.dynamic, ["yearsFromNow", 2]))});
    }
  };
  ...
  material_datepicker__range.QuarterRange = class QuarterRange extends core.Object {
    ...
    static _quartersAgoMsg(quartersAgo) {
      return intl$.Intl.plural(core.int._check(quartersAgo), {zero: "This quarter", one: "Last quarter", other: dart.str(quartersAgo) + " quarters ago", name: "_quartersAgoMsg", args: [quartersAgo], desc: "A date range spanning a single quarter in the past.", examples: const$12 || (const$12 = dart.constMap(core.String, dart.dynamic, ["quartersAgo", 2]))});
    }
    static _quartersFromNowMsg(quartersFromNow) {
      return intl$.Intl.plural(core.int._check(quartersFromNow), {zero: "This quarter", one: "Next quarter", other: dart.str(quartersFromNow) + " quarters from now", name: "_quartersFromNowMsg", args: [quartersFromNow], desc: "A date range spanning a single quarter in the future.", examples: const$13 || (const$13 = dart.constMap(core.String, dart.dynamic, ["quartersFromNow", 2]))});
    }
  };
