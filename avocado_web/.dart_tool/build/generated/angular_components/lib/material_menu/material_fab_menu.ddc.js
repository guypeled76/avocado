define(['dart_sdk', 'packages/angular_components/model/menu/menu', 'packages/angular_components/laminate/enums/alignment', 'packages/angular_components/utils/id_generator/id_generator', 'packages/angular_components/model/observable/observable', 'packages/angular_components/utils/browser/events/events', 'packages/angular_components/material_popup/material_popup', 'packages/angular_components/model/a11y/keyboard_handler_mixin', 'packages/angular_components/mixins/track_layout_changes', 'packages/angular/src/core/change_detection/change_detection'], function(dart_sdk, menu, alignment, id_generator, observable, events, material_popup, keyboard_handler_mixin, track_layout_changes, change_detection) {
  ...
  const $any = dartx.any;
  let ActiveMenuItemModelOfMenuItem = () => (ActiveMenuItemModelOfMenuItem = dart.constFn(model__menu__menu.ActiveMenuItemModel$(model__menu__menu.MenuItem)))();
  ...
  let MenuModelOfMenuItem = () => (MenuModelOfMenuItem = dart.constFn(model__menu__menu.MenuModel$(model__menu__menu.MenuItem)))();
  ...
  const Object_KeyboardHandlerMixin$ = class Object_KeyboardHandlerMixin extends core.Object {};
  ...
  const Object_TrackLayoutChangesMixin$ = class Object_TrackLayoutChangesMixin extends Object_KeyboardHandlerMixin$ {};
  (Object_TrackLayoutChangesMixin$.new = function() {
    mixins__track_layout_changes.TrackLayoutChangesMixin.new.call(this);
    Object_TrackLayoutChangesMixin$.__proto__.new.call(this);
  ...
  material_menu__material_fab_menu.MaterialFabMenuComponent = class MaterialFabMenuComponent extends Object_TrackLayoutChangesMixin$ {
    ...
    static new(changeDetector, idGenerator) {
      return new material_menu__material_fab_menu.MaterialFabMenuComponent.__(changeDetector, idGenerator != null ? idGenerator : new utils__id_generator__id_generator.SequentialIdGenerator.fromUUID());
    }
    get onShow() {
    ...
    handleKeyDown(event) {
      switch (event.keyCode) {
        ...
        {
          this.openMenuAndActivateLastItem();
          break;
        }
        case html.KeyCode.DOWN:
        {
          this.openMenuAndActivateFirstItem();
          break;
        }
      }
    }
    ...
    openMenuAndActivateFirstItem() {
      if (dart.test(this.hasMenu)) {
        this.activeModel.menu = MenuModelOfMenuItem()._check(this.menuItem.subMenu);
      }
  ...
  (material_menu__material_fab_menu.MaterialFabMenuComponent.__ = function(changeDetector, idGenerator) {
    ...
    this[activeModel] = new (ActiveMenuItemModelOfMenuItem()).new(idGenerator);
  ...
  const activeModel = Symbol("MaterialFabMenuComponent.activeModel");
  ...
  dart.setMethodSignature(material_menu__material_fab_menu.MaterialFabMenuComponent, () => ({
    ...
    openMenuAndActivateFirstItem: dart.fnType(dart.void, []),
    openMenuAndActivateLastItem: dart.fnType(dart.void, []),
  ...
  dart.setFieldSignature(material_menu__material_fab_menu.MaterialFabMenuComponent, () => ({
    ...
    activeModel: dart.finalFieldType(ActiveMenuItemModelOfMenuItem()),
