define(['dart_sdk', 'packages/angular_components/src/material_tree/group/material_tree_group.scss.css.shim'], function(dart_sdk, material_tree_group$46scss$46css) {
  'use strict';
  const core = dart_sdk.core;
  const dart = dart_sdk.dart;
  const dartx = dart_sdk.dartx;
  const src__material_tree__group__material_tree_group$46template = material_tree_group$46scss$46css.src__material_tree__group__material_tree_group$46template;
  const src__material_tree__material_tree_dropdown$46template = material_tree_group$46scss$46css.src__material_tree__material_tree_dropdown$46template;
  const src__material_tree__material_tree_expand_state$46template = material_tree_group$46scss$46css.src__material_tree__material_tree_expand_state$46template;
  const src__material_tree__material_tree_impl$46template = material_tree_group$46scss$46css.src__material_tree__material_tree_impl$46template;
  const src__material_tree__material_tree_rendering_options$46template = material_tree_group$46scss$46css.src__material_tree__material_tree_rendering_options$46template;
