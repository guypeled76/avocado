define(['dart_sdk', 'packages/angular/angular.template', 'packages/angular_components/utils/angular/scroll_host/interface.template', 'packages/angular_components/utils/async/async.template', 'packages/angular_components/utils/browser/dom_service/dom_service.template', 'packages/angular_components/utils/disposer/disposer.template', 'packages/angular_components/utils/browser/events/events.template', 'packages/angular_components/utils/browser/feature_detector/feature_detector.template', 'packages/angular_components/src/utils/angular/scroll_host/scroll_host_interface.template'], function(dart_sdk, angular, $interface, async, dom_service, disposer, events, feature_detector, scroll_host_interface) {
  ...
  }, '{"version":3,"sourceRoot":"","sources":["pan_controller_impl.template.dart","position_sticky_controller.template.dart","sticky_controller_impl.template.dart","scroll_host_base.template.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;MAYI,yEAAQ;YAAG;;;;;AAEb,kBAAI,yEAAQ,GAAE;AACZ;;AAEF,gFAAW;AAEX,IAAM,gCAAa;AACnB,IAAM,+DAAa;AACnB,IAAM,4CAAa;AACnB,IAAM,iEAAa;AACnB,IAAM,kDAAa;EACrB;;MCdI,gFAAQ;YAAG;;;;;AAEb,kBAAI,gFAAQ,GAAE;AACZ;;AAEF,uFAAW;AAEX,IAAM,+DAAa;AACnB,IAAM,uDAAa;AACnB,IAAM,2EAAa;EACrB;;MCXI,4EAAQ;YAAG;;;;;AAEb,kBAAI,4EAAQ,GAAE;AACZ;;AAEF,mFAAW;AAEX,IAAM,+DAAa;AACnB,IAAM,iEAAa;EACrB;;MCAI,sEAAQ;YAAG;;;;;AAEb,kBAAI,sEAAQ,GAAE;AACZ;;AAEF,6EAAW;AAEX,IAAM,gCAAa;AACnB,IAAM,mEAAa;AACnB,IAAM,8EAAa;AACnB,IAAM,qFAAa;AACnB,IAAM,iFAAa;AACnB,IAAM,gFAAa;AACnB,IAAM,iFAAa;AACnB,IAAM,4CAAa;AACnB,IAAM,iEAAa;AACnB,IAAM,2EAAa;AACnB,IAAO,kDAAa;EACtB","file":"pan_controller_impl.template.ddc.js"}');
  // Exports:
  return {
