define(['dart_sdk', 'packages/angular_components/material_datepicker/comparison_option', 'packages/angular_components/material_datepicker/comparison', 'packages/angular_components/material_datepicker/calendar', 'packages/angular_components/model/observable/observable', 'packages/angular_components/model/date/date', 'packages/angular_components/utils/disposer/disposer', 'packages/angular_components/material_datepicker/range', 'packages/angular_components/src/material_datepicker/sequential', 'packages/angular/src/core/zone/ng_zone', 'packages/angular_components/src/utils/angular/scroll_host/scroll_host_interface', 'packages/intl/intl'], function(dart_sdk, comparison_option, comparison, calendar, observable, date, disposer, range, sequential, ng_zone, scroll_host_interface, intl) {
    ...
    set comparisonEnabled(enabled) {
      ...
      if (dart.test(enabled) && this[_scrollHost] != null) {
        this[_ngZone].runAfterChangesObserved(dart.fn(() => {
          return this[_scrollHost] == null ? null : this[_scrollHost].scrollToPosition(this[_scrollHost].scrollLength);
        }, VoidTovoid()));
      }
    }
  ...
  (src__material_datepicker__comparison_range_editor.ComparisonRangeEditorComponent.new = function(ngZone, scrollHost) {
    this[model] = null;
  ...
  dart.setSetterSignature(src__material_datepicker__comparison_range_editor.ComparisonRangeEditorComponent, () => ({
    __proto__: dart.getSetters(src__material_datepicker__comparison_range_editor.ComparisonRangeEditorComponent.__proto__),
    comparisonEnabled: core.bool
  }));
  ...
  dart.defineLazy(src__material_datepicker__comparison_range_editor.ComparisonRangeEditorComponent, {
    /*src__material_datepicker__comparison_range_editor.ComparisonRangeEditorComponent.comparisonHeaderMsg*/get comparisonHeaderMsg() {
