define(['dart_sdk', 'packages/angular_components/utils/disposer/disposer', 'packages/angular_components/src/laminate/popup/popup_hierarchy', 'packages/angular_components/src/utils/async/async_update_scheduler', 'packages/angular_components/model/ui/toggle', 'packages/angular_components/src/laminate/popup/dom_popup_source', 'packages/angular_components/laminate/enums/visibility', 'packages/angular_components/focus/focus_interface', 'packages/angular_components/laminate/enums/alignment', 'packages/angular_components/content/deferred_content_aware', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular_components/mixins/material_dropdown_base', 'packages/angular/src/bootstrap/modules', 'packages/angular/src/core/zone/ng_zone', 'packages/angular_components/src/laminate/overlay/overlay_ref', 'packages/angular_components/utils/browser/dom_service/dom_service', 'packages/angular_components/laminate/overlay/zindexer', 'packages/angular_components/utils/id_generator/id_generator'], function(dart_sdk, disposer, popup_hierarchy, async_update_scheduler, toggle, dom_popup_source, visibility, focus_interface, alignment, deferred_content_aware, change_detection, material_dropdown_base, modules, ng_zone, overlay_ref, dom_service, zindexer, id_generator) {
    ...
    [_close]() {
      ...
      if (focus__focus_interface.Focusable.is(this.state.source) && dart.test(this.hierarchy.islastTriggerWithKeyboard)) {
        this[_domService].scheduleWrite(dart.fn(() => {
          if (dart.test(html.window[$document].activeElement[$classes].contains("acx-overlay-focusable-placeholder")) || dart.test(this[_overlayRef].overlayElement.contains(html.window[$document].activeElement))) {
  ...
  (material_popup__material_popup.MaterialPopupComponent.new = function(hierarchy, parentPopup, role, ngZone, overlayService, domService, zIndexer, defaultPreferredPositions, useRepositionLoop, popupSizeProvider, changeDetector, viewContainer, elementRef) {
