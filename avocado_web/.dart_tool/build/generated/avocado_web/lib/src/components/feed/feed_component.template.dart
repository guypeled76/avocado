...
class _ViewFeedComponentHost0 extends AppView<import1.FeedComponent> {
  ...
  ComponentRef<import1.FeedComponent> build() {
    ...
    _FeedComponent_0_5 = (import10.isDevMode
        ? import15.debugInjectorWrap(import1.FeedComponent, () {
            return import1.FeedComponent(this.injectorGet(import16.StoreService, viewData.parentIndex));
          })
        : import1.FeedComponent(this.injectorGet(import16.StoreService, viewData.parentIndex)));
