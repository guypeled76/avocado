...
import 'package:avocado_web/src/services/services.template.dart' as _ref4;
...
import 'package:avocado_web/src/services/store.dart' as _i3;
...
import 'package:avocado_common/src/services/store.dart' as _i12;
...
class _Injector$rootInjector extends _i2.HierarchicalInjector {
  ...
  _i3.StoreServiceImpl _getStoreServiceImpl$0() => _field0 ??= _i3.StoreServiceImpl(this.get(_i1.Injector));
  ...
  Object injectFromSelfOptional(Object token, [Object orElse = _i1.throwIfNotFound]) {
    if (identical(token, _i12.StoreService)) {
      return _getStoreServiceImpl$0();
    }
