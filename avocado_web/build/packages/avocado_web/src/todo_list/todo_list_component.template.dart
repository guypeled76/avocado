...
import 'package:angular/src/common/directives/ng_for.dart' as import30;
import 'package:angular_components/material_checkbox/material_checkbox.template.dart' as import31;
import 'package:angular_components/material_checkbox/material_checkbox.dart' as import32;
import 'dart:core';
import 'todo_list_service.dart' as import34;
...
class ViewTodoListComponent0 extends AppView<import2.TodoListComponent> {
  ...
  ComponentRef<import2.TodoListComponent> build() {
    ...
    addShimC(_el_6);
    _FeedComponent_6_5 = import15.FeedComponent();
  ...
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    ...
    if ((identical(token, const import24.MultiToken<dynamic>('NgValidators')) && (1 == nodeIndex))) {
    ...
    if (((((identical(token, import6.MaterialInputComponent) || identical(token, import26.ReferenceDirective)) || identical(token, import27.Focusable)) || identical(token, import28.HasDisabled)) && (1 == nodeIndex))) {
...
class _ViewTodoListComponent2 extends AppView<import2.TodoListComponent> {
  ...
  ComponentRef<import2.TodoListComponent> build() {
    ...
    _NgFor_2_9 = import30.NgFor(_appEl_2, _TemplateRef_2_8);
    init0(_el_0);
  }
...
class _ViewTodoListComponent3 extends AppView<import2.TodoListComponent> {
  import31.ViewMaterialCheckboxComponent0 _compView_1;
  import32.MaterialCheckboxComponent _MaterialCheckboxComponent_1_5;
  ...
  ComponentRef<import2.TodoListComponent> build() {
    ...
    addShimE(_el_0);
    _compView_1 = import31.ViewMaterialCheckboxComponent0(this, 1);
    final _el_1 = _compView_1.rootEl;
    _el_0.append(_el_1);
    createAttr(_el_1, 'materialTooltip', 'Mark item as done');
    addShimC(_el_1);
    _MaterialCheckboxComponent_1_5 = import32.MaterialCheckboxComponent(_el_1, _compView_1.ref, null, null, null);
  ...
  @override
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    if ((identical(token, import28.HasDisabled) && (1 == nodeIndex))) {
  ...
  void detectChangesInternal() {
    bool changed = false;
    bool firstCheck = (this.cdState == 0);
    final import32.MaterialCheckboxComponent local_done = _MaterialCheckboxComponent_1_5;
...
class _ViewTodoListComponentHost0 extends AppView<import2.TodoListComponent> {
  ...
  import34.TodoListService _TodoListService_0_5;
  ...
  ComponentRef<import2.TodoListComponent> build() {
    ...
    _TodoListService_0_5 = import34.TodoListService();
  ...
  @override
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    if ((identical(token, import34.TodoListService) && (0 == nodeIndex))) {
